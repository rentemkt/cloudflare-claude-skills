// JavaScript Principal - Versão Corrigida e Simplificada
// Espaço Consciência - Site Multilíngue
...
window.EspacoConsciencia = {
    ...
    initLanguageSelector: function() {
        ...
        languageOptions.forEach(option => {
            option.addEventListener('click', (e) => {
                e.preventDefault();
                this.changeLanguage(option.dataset.language, option.textContent);
            });
        });
    },
    
    // Troca de idioma
    changeLanguage: function(lang, displayText) {
        this.currentLanguage = lang;
        
        // Atualiza botão principal
        const languageButton = document.getElementById('languageButton');
        if (languageButton) {
            languageButton.innerHTML = displayText;
        }
    ...
    // Aplica traduções básicas
    applyBasicTranslations: function(lang) {
        const translations = {
            pt: {
                'Início': 'Início',
                'Sobre': 'Sobre',
            ...
            en: {
                ...
                'Consulta Presencial': 'In-Person Consultation'
            },
            es: {
                'Início': 'Inicio',
                'Sobre': 'Acerca',
        ...
        Object.keys(currentTranslations).forEach(key => {
            const elements = document.querySelectorAll(`[data-translate="${key}"], .nav-link, .btn-primary span, .btn-secondary span`);
            elements.forEach(el => {
